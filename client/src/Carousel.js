...
// modular function to return a positive value
    const mod = (n, m) => {
        let result = n % m;
    ...
    <div className='carousel-parent'>
        ...
        {tiles.map((item, i) => {
          ...
          return (
            ...
            {/* <img className= "card-far-left" src={bb15} alt="bb15.png" />
            <img className= "card-left" src={dbb12} alt="dbb12.png" />
            <img className= "card-highlight" src={yc11} alt="yc11.png" />
            <img className= "card-right" src={nn7} alt="nn7.png" />
            <img className= "card-far-right" src={ss14} alt="ss14.png" /> */}
        </div>
